...
const printDiputadosSchema = new Schema({
    ...
    prd: {type: Number, required: true},
    moda: {type: Number, required: true},
    afamplio: {type: Number, required: true},
    alpais: {type: Number, required: true},
    plr: {type: Number, required: true},
...
module.exports = mongoose.model('PrintDiputados', printDiputadosSchema);
